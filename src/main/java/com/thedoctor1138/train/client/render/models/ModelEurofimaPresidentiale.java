...
public class ModelEurofimaPresidentiale extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelEurofimaPresidentiale() //Same as Filename
	{
	...
	ModelEuroFimaBogie bogie = new ModelEuroFimaBogie();
	@Override
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		Tessellator.bindTexture(new ResourceLocation(TCMLPAddonInfo.resourceLocation, "textures/trains/Eurofimabogie.png"));

		GL11.glPushMatrix();
		GL11.glTranslated(-4.7, -0.1, 0);
		bogie.render(entity, f, f1, f2, f3, f4, f5);

		GL11.glTranslated(9.3, -0.1, 0);
		bogie.render(entity, f, f1, f2, f3, f4, f5);
		GL11.glPopMatrix();

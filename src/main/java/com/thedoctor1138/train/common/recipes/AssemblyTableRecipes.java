    ...
    public static void recipes() {
        ...
        ITierCraftingManager cm = TierRecipeManager.getInstance();
            ...
            for (ItemStack dye : dyeBlue){
                ...
                cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), null, null, new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.transformer.item, 2), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(ItemIDs.transformer.item, 4), dye, new ItemStack(TCMLPItemIDs.minecartNGT6ERLoco.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.steel.item, 3), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(ItemIDs.steel.item, 3), null, new ItemStack(ItemIDs.steelcab.item, 1), null, new ItemStack(ItemIDs.seats.item, 4), null, dye, new ItemStack(TCMLPItemIDs.minecartBR_MK3_Sleeper.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.steel.item, 3), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(ItemIDs.steel.item, 3), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, new ItemStack(ItemIDs.seats.item, 3), null, dye, new ItemStack(TCMLPItemIDs.minecart4WheeledCoach.item, 1), 1);
        }

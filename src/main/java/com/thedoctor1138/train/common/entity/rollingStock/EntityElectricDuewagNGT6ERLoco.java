...
public class EntityElectricDuewagNGT6ERLoco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricDuewagNGT6ERLoco(World world) {
        super(world);

    }

    public EntityElectricDuewagNGT6ERLoco(World world, double d, double d1, double d2) {
        this(world);

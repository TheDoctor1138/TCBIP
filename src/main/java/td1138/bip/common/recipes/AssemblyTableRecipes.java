package td1138.bip.common.recipes;
...
public class AssemblyTableRecipes {
    ...
    public static void recipes() {
        ...
        ITierCraftingManager cm = TierRecipeManager.getInstance();
            ...
            for (ItemStack dye : dyeBlue){
                cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 3), null, null, new ItemStack(ItemIDs.steelcab.item, 2), new ItemStack(ItemIDs.dieselengine.item, 1), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(ItemIDs.transformer.item, 2), dye, new ItemStack(TCBIPItemIDs.minecartClass74.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(ItemIDs.steel.item, 1), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.electmotor.item, 4), new ItemStack(ItemIDs.dieselengine.item, 2), new ItemStack(ItemIDs.generator.item, 2), dye, new ItemStack(TCBIPItemIDs.minecartClass20.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), null, null, new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.transformer.item, 2), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(ItemIDs.transformer.item, 4), dye, new ItemStack(TCBIPItemIDs.minecartClass88.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), null, null, new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.transformer.item, 2), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(ItemIDs.transformer.item, 4), dye, new ItemStack(TCBIPItemIDs.minecartNGT6ERLoco.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.steel.item, 3), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(ItemIDs.steel.item, 3), null, new ItemStack(ItemIDs.steelcab.item, 1), null, new ItemStack(ItemIDs.seats.item, 4), null, dye, new ItemStack(TCBIPItemIDs.minecartBR_MK3_Sleeper.item, 1), 1);
                cm.addRecipe(3, new ItemStack(ItemIDs.steel.item, 3), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(ItemIDs.steel.item, 3), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, new ItemStack(ItemIDs.seats.item, 3), null, dye, new ItemStack(TCBIPItemIDs.minecart4WheeledCoach.item, 1), 1);
        }

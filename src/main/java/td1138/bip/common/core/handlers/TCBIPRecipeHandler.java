...
//        }
        ...
        GameRegistry.addRecipe(new ItemStack(TCBIPItemIDs.recipeBook.item, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );
    }
    ...
    public static void initItemRecipes() {
       ...
       var10 = iron.iterator();
        ...
        TrainCraftingManager.instance.addRecipe(new ItemStack(TCBIPItemIDs.recipeBook.item, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );

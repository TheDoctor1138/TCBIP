...
public class RenderBR_3_Aspect_Signal extends TileEntitySpecialRenderer {
    ...
    //  private static final ResourceLocation texture = new ResourceLocation(TCBIPInfo.resourceLocation,TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Red.png");
    //  private static final ResourceLocation texture2 = new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Green.png");
    //  private static final ResourceLocation texture3 = new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Yellow.png");

    private ResourceLocation[] textures = {new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Red.png"),
                                           new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Green.png"),
                                           new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_3_Aspect_Signal_Yellow.png")};

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        boolean state=((TileBR_3_Aspect_Signal) tileEntity).skinstate == 0;
        GL11.glPushMatrix();

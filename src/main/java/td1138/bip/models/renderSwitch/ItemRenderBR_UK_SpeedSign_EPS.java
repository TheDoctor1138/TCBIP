...
public class ItemRenderBR_UK_SpeedSign_EPS implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign_EPS modelSwitch = new ModelBR_UK_SpeedSign_EPS();
    private static final ResourceLocation texture = new ResourceLocation(TCBIPInfo.resourceLocation,TCBIPInfo.modelTexPrefix + "BR_UK_SpeedSign_EPS_110125.png");
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.modelTexPrefix + "BR_UK_SpeedSign_EPS_110125.png"));
        switch (type) {
            case ENTITY: {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(TCBIPInfo.modID.toLowerCase() + ":br_uk_speedsign_eps");
    }

...
import td1138.bip.client.core.handlers.RecipeBookHandler;
import train.common.blocks.TCBlocks;
import train.common.core.managers.TierRecipe;
import train.common.core.managers.TierRecipeManager;
import train.common.inventory.TrainCraftingManager;
import td1138.bip.common.items.ItemRecipeBook;
...
public class GuiRecipeBook extends GuiScreen {
    ...
    public GuiRecipeBook(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack) {
        ...
        this.addPage("Welcome to the TC BIP guide! \nThis book contains everything you need to know about the BIP addon.\n\nAuthors:\nTheDoctor1138,\n\nThanks to CovertJaguar for his help and a great API.\n", "", "left", new ArrayList<StackToDraw>() {
            {
        ...
        this.addPage("On the following pages you will find all the train workbench recipes and assembly table recipes.\nIt is however strongly suggested to try to discover the recipes by yourself...\n\nWe hope you will enjoy the mod!\n\nSpitfire4466 and MrBrutal", "", "left", new ArrayList<StackToDraw>() {
            {
                this.add(GuiRecipeBook.this.new StackToDraw(new ItemStack(TCBlocks.trainWorkbench), 20, 16));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (this.currPage > 0) {
            this.mc.renderEngine.bindTexture(new ResourceLocation("tcbip", "textures/gui/book/bookright.png"));
            this.drawTexturedModalRect(var5, var6, 0, 0, this.bookImageWidth, this.bookImageHeight + 20);
            this.mc.renderEngine.bindTexture(new ResourceLocation("tcbip", "textures/gui/book/bookleft.png"));
            ...
            this.mc.renderEngine.bindTexture(new ResourceLocation("tcbip", "textures/gui/book/bookcover.png"));

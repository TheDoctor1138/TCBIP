package td1138.bip.client.render;


import fexcraft.tmt.slim.ModelBase;
import net.minecraft.util.ResourceLocation;
import td1138.bip.client.render.models.*;
...
public enum TCBIPRenderEnum implements TrainRenderRecord {
	...
	Hornby040E2(EntityLocoSteamHornby040E2.class, new ModelHornby040E2(), "0_4_0_E2_", true, new float[]{0.5f, 0.17f, 0}, new float[]{0, 180, 180}, null, "largesmoke", 3, new ArrayList<double[]>() {
		{
    ...
    public ResourceLocation getTextureFile(String colorString) {
		if (multiTexture) {
			return new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.trainsPrefix + texture + colorString + ".png");
		} else {
			return new ResourceLocation(TCBIPInfo.resourceLocation, TCBIPInfo.trainsPrefix + texture + ".png");
		}
	}

...
public class EntityLocoDieselClass68 extends DieselTrain {
     ...
     *     @see #EntityLocoDieselClass68(World) (World, double, double, double)
     *     The last part defines the unlocalized name, this is used for the item name, entity name, and language file entries.
     */


    public static final Item thisItem = new ItemRollingStock(new EntityLocoDieselClass68(null), TCBIPInfo.modID, TCBIP.tabBIP);
     ...
     * @see Locomotive
     */
    public EntityLocoDieselClass68(World world, double x, double y, double z){
        super(world, x, y, z);
    }
    ...
    @Override
    public String transportName(){return "BR Class 68";}
    @Override
    public String transportcountry(){return "uk";}
    @Override
    public String transportYear(){return "2014";}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(), TCBIPInfo.modID,"textures/trains/Class_68_Blue.png", new String[]{} ,"default", "Class 68 in Plain DRS Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TCBIPInfo.modID,"textures/trains/Class_68_Purple.png", new String[]{}, "Purple", "Class 68 in DRS livery.");
        SkinRegistry.addSkin(this.getClass(), TCBIPInfo.modID,"textures/trains/Class_68_Cyan.png", new String[]{}, "Cyan", "Class 68 in Scotrail  livery.");
        SkinRegistry.addSkin(this.getClass(), TCBIPInfo.modID,"textures/trains/Class_68_LightBlue.png", new String[]{}, "Light Blue", "Class 68 in Tranpennine Express livery.");
        SkinRegistry.addSkin(this.getClass(), TCBIPInfo.modID,"textures/trains/Class_68_Grey.png", new String[]{}, "Grey", "Class 68 in Chiltern Railways livery.");
     ...
     */
    @Override
    public float transportMetricHorsePower(){return 3800f;}

    @Override
    public String[] additionalItemText() {
        return new String[]{"Please bare with me.."};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new ModelClass68()};}
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getRunningSound(){return new TrainSound("tcbip:Class68Thrash",0.7f,1,1);}
    @SideOnly(Side.CLIENT)
    @Override

...
public class TCBIPRecipeHandler  {
    public TCBIPRecipeHandler() {
    }
...
//        }
        ...
        GameRegistry.addRecipe(new ItemStack(TCBIPItems.itemBIPRecipeBook, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );
    }
    ...
    public static void initItemRecipes() {
       ...
       var10 = iron.iterator();
        ...
        TrainCraftingManager.instance.addRecipe(new ItemStack(TCBIPItems.itemBIPRecipeBook, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );
